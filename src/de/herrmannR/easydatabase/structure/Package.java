...
public class Package {
	...
	public Package(String[] columnNames, String[] dataTypes, Set<String> primaryKeys, int columnCount) {
		if (columnCount < 1) {
			throw new IllegalArgumentException("RowPackage has to have at least one column, but columnCount is " + columnCount);
		}
	...
	protected void checkValidAccess(int column) {
